...
/**
 * The qtype selfassess solution viewed event class
 * 
 ...
 */
class solution_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the solution with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('eventsolutionviewed', 'qtype_selfassess');
    }
