...
/**
 * The qtype selfassess question viewed event class
 * 
...
class question_viewed extends \core\event\base {
    ...
    public function get_description() {
         return "The user with id '$this->userid' has viewed the question with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('eventquestionviewed', 'qtype_selfassess');
    }
