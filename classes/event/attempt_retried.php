...
/**
 * The qtype_selfassess attempt retried event class
 *
 ...
 */
class attempt_retried extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has performed retry no. {$this->other['retry']} for 
            question id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('eventquestionattemptretried', 'qtype_selfassess');
    }
